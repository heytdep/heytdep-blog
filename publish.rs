...
<p>Hi I'm Tommaso, I am a developer building interesting stuff on the Stellar Network at <a target="_blank" href="https://github.com/xycloo/">Xycloo</a>, and currently part-time contractor helping to build the <a target="_blank" href="https://quest.stellar.org/">Stellar Soroban Quest</a>. My current focus lies in Decentralized ledger technology, smart contracts, Decentralized Finance, and SaaS. Articles with the &#128215 prefix are intended to be read by a general public, those with the &#128216 prefix are mostly personal notes.</p>
